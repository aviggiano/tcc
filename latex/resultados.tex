...
Definimos que a aquisição de dados seria feita a partir de uma base arbitrária, que deveria alimentar o sistema por meio de arquivos de texto com valores separados por vírgulas (\texttt{.csv}).
