...
Por fim, o sistema de recomendação deverá ser escalável e flexível no sentido de poder operar igualmente bem tanto em pequenas quanto em grandes bases de dados.
 ...
 Apesar serem importantes parâmetros de um sistema de recomendação, o \textit{throughput} e a escalabilidade estão intimamente relacionados ao orçamento do projeto. Neste trabalho, assumimos que o sistema de operará em microcomputadores pessoais.