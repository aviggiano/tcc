...
\begin{description}
 	...
 	\item[16/07] Programação método \textit{FW}, descrito na Seção \ref{sec:algoritmo_baseado_na_pondera_o_de_atributos_}
 	\item[23/07] Programação metodo \textit{UP}, descrito no Seção \ref{sec:algoritmo_baseado_no_perfil_de_usu_rios_}
