...
\begin{description}
 	...
 	\item[16/07] Programação do método \textit{FW}, descrito na Seção \ref{sec:algoritmo_baseado_na_pondera_o_de_atributos_}
 	\item[23/07] Programação do metodo \textit{UP}, descrito no Seção \ref{sec:algoritmo_baseado_no_perfil_de_usu_rios_}
 	\item[30/07] Anális comparativa dos dois algoritmos
