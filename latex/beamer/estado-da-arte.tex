...
\structure{\textbf{\textit{Cold start}}}

\structure{\textbf{Esparsidade}}
...
\structure{\textbf{Excesso de especialização}}

\structure{\textbf{Análise ``superficial'' do conteúdo}}

\par{~}

\textbf{Métodos híbridos}

\structure{\textbf{Escalabilidade}}
