...
Assim como era de se esperar, a medida que o tamanho da lista de recomendações aumenta, a precisão cai e a abrangência cresce. O método TODO supera os dois outros algoritmos, etc tal
