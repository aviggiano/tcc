...
% ---
\titulo{Desenvolvimento de um Sistema de Recomendação para E-Commerces}
...
\preambulo{Trabalho de conclusão de Curso apresentado ao Departamento de Engenharia Mecatrônica da Escola Politécnica da Universidade de São Paulo comrequisito parcial para obtenção do Grau de Engenheiro Mecatrônico.}
% ---
...
%\pagebreak
%\appendix
%\input{referencias-bibliograficas-finais}
%\pagebreak
\input{sumario-final}
% ----------------------------------------------------------
