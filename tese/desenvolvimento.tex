...
O vetor $\mathbf{w}$ contém os pesos de cada um dos atributos $f$, e é obtido através da regressão linear de Equação \ref{eq:determinacao-wf}.

% subsubsection determina_o_de_w_f_ (end)
