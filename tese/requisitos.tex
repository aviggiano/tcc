...
O terceiro caso \texit{Gerar Recomendações} é o caso onde o dá ínicio aos cálculos das recomendações com o método e o banco de dados préviamente escolhidos, o que caracteriza dependência indicada na figura.
