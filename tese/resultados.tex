...
Assim como mostra a literatura, a medida que o tamanho da lista de recomendações aumenta, a precisão cai e a abrangência cresce (Figura \ref{fig:N}). O método UP supera os dois outros algoritmos para o valor padrão de $N$, tanto em precisão quanto em abrangência. 

\begin{center}
\begin{figure}[ht]
    \begin{center}
    \includegraphics[width=1\textwidth]{img/N}
    \end{center}
    \label{fig:N}
